...
The simple peerfinder (peerfinder.py) script scans the nodes registered with the peer finder (found under servers/) and returns the closest peers by latency.
